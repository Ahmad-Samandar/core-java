...
public class WhatIsIDE {
    ...
    *     What is IDE?
        ...
        * canvas, easel, and a set of brushes makes the job a
        * whole lot easier and more organized. Similarly,
        * when you're writing Java code (or code in other languages),
        * you could use a basic text editor,
