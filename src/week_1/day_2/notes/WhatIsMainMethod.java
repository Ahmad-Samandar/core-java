...
public class WhatIsMainMethod {
    ...
    * the main method!
     ...
     Think of it like the ignition key of a car. Just like turning the key starts the engine and sets the car in motion,
     *  the main method is the starting point for any standalone Java program. When you run your Java program, the code
     * inside the main method is what gets executed first.
